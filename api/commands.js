...
import { CommandData as UpdateCommands } from "../commands/application/updatecommands.js";
// COMMANDS.push({
//     name: 'support',
...
export default async (req, res) => {
    const result = await InstallGlobalCommands([CheckAPI, Superlative, Ping, Embed, Immune, Weekly, UpdateCommands]);
