...
export async function GET(request: NextRequest): Promise<Response> {
    ...
    if (guild === "duck") {
        if (status === "joined") {
            ...
            await AddGuildMemberRole(IsleofDucks.serverID, data.data.discord.discordid, IsleofDucks.roles.new_guild_member);
        } else if (status === "left") {
            ...
            await RemoveGuildMemberRole(IsleofDucks.serverID, data.data.discord.discordid, IsleofDucks.roles.new_guild_member);
        }
