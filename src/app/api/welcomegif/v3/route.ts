...
export async function GET(request: NextRequest): Promise<Response> {
    ...
    const filePath = path.join(process.cwd(), "public", "images", "welcome3.gif");
    ...
    const height = width;
    const xCenter = gifWidth - width / 2 - offset * 2; // Centered horizontally in the right half of the GIF
