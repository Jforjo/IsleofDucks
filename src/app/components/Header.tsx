    ...
    return (
        <header className="fixed left-1/2 -translate-x-1/2 top-8 flex justify-between items-center p-2 gap-6 rounded-2xl bg-slate-300 bg-opacity-25 backdrop-blur">
            ...
            { session ? (
                <button
                    type="submit"
                    className="flex justify-center items-center rounded-lg h-8 font-bold py-2 px-4 gap-1 bg-blurple"
                    onClick={() => signOut()}
                >
                    <svg className="h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 127.14 96.36">
